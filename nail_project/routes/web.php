...
Route::get('/recomentShops', [ListNailShopController::class, 'recomentShops'])->name('nearbyShops');
Route::get('/allShops', [ListNailShopController::class, 'allShops'])->name('nearbyShops');
