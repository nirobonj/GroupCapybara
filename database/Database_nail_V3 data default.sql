...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2024 at 05:41 PM
...
('B0001', 'S0001', 6, '2024-09-18', '22:00:00', '2024-09-19', '14:00:00'),
('B0002', 'S0002', 6, '2024-09-08', '18:00:00', '2024-10-20', '17:02:00'),
('B0003', 'S0003', 7, '2024-09-18', '22:15:00', '2024-09-23', '11:00:00'),
('B0004', 'S0001', 7, '2024-09-08', '18:00:00', '2024-09-25', '13:30:00');
...
('S0001', 6, 'B0001', 'คือดี ตรงเรฟมาก ชอบๆ', 5),
('S0002', 6, 'B0002', 'สวยๆ วันนี้พาเพื่อนไปทำเพื่อนชอบมาก เดี๋ยวอาทิตย์หน้าพาเพื่อนไปอีกจ้า', 5),
('S0003', 7, 'B0003', 'ก็ดีแต่แพง และทำช้าไปหน่อย แต่ก็ตรงเรฟ ขอหักดาวนิดนึงนะคะ', 4.5),
('S0001', 7, 'B0004', 'สวยเป๊ะปัง คือนี่แหละ ถูกต้องที่สุดแล้ว', 5);
...
('CohDEYD5mtgvt2uV7IpRe6W4YkLW6vktBGgj4JKk', 6, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '', 1726757760),
('lnPe2KwiKnSBCpm7DaagJRoOyisoqCeqHlYlM03f', 7, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '', 1726759663),
('xb8Mi8zkzIqxgjwCaqhCBaTNhOwV0Wnnk5BN4Nqm', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoicHBGR01EakxVbm9NaFJiNGFHUkdCZXFQbGlIMVBQU2tPWm9rcnJFdCI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzA6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9yZWdpc3RlciI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1726753424);
...
INSERT INTO `shop` (`shop_id`, `user_id`, `shop_name`, `promotion_detail`, `shop_address`, `shop_description`, `pvc`, `clean_nail`, `images_name`) VALUES
('S0001', 1, 'Dailydivine by xviippa', '- SET DUO ! ทาสีพื้น 2 สี 2 คน หรือเก็บไว้ใช้ครั้งถัดไปได้ 199฿\r\n- BUFFET A! ทาสีพื้น + อะไหล่ไม่จำกัด 249฿\r\n- BUFFET B! ทาสีลูกแก้ว/กลิตเตอร์ + อะไหล่ไม่จำกัด 299฿', 'หอ VS หน้า ม.เกษตร กำแพงแสน', 'แม่ค้ามีประสบการณ์ สถานที่พร้อมรับลูกค้า และบริการ...', '150฿', '50-150฿ แล้วแต่กรณี', 'img01.png'),
('S0002', 2, 'friendlynail.kps', 'เล็บเจล\r\nทำเล็บสีพื้น 200฿ ฟรี!! แคร์เจล + อะไหล่ 2 นิ้ว\r\nทำเล็บเจลแคทอาย 250฿ ฟรี!! แคร์เจล + อะไหล่ 4 นิ้ว', 'หอ infinity หน้า ม.เกษตรกำแพงแสน', 'รับทำเล็บเจลค่า', '150฿', '50-150฿ แล้วแต่กรณี', 'img02.jpg'),
('S0003', 3, 'carafiona.nail', '- ', 'หอนกฮูก 3 ตึก A หน้า ม.เกษตรกำแพงแสน', 'ทำเล็บกับร้านเรา ทุกคนจะต้องน่ารักแน่นอน', '120-150฿', '50-100฿ แล้วแต่กรณี', 'img03.jpg'),
('S0004', 4, 'minttynail', 'ทาสีเจล สีพื้น มือเท้า 300฿ เท่านั้น\r\nเพ้นท์ลาย 250 ทุกแบบ\r\nเฉพาะวันพุธและวันพฤหัสนี้เท่านั้นจ้า', 'ตึกพาญิชย์หน้าหอไอเพลส หน้า ม.เกษตรกำแพงแสน', 'คิดถึงเล็บ คิดถึงเรา', '150฿', '50-150฿ แล้วแต่กรณี', 'img04.png'),
('S0005', 5, 'nail.bybelle', '-', 'หอเคพีเขียว หน้า ม.เกษตรกำแพงแสน', 'รับทำเล็บ สนใจทัก DM สอบถามข้อมูลได้ค่ะ', '150฿', '50-150฿ แล้วแต่กรณี', 'img05.jpg');
